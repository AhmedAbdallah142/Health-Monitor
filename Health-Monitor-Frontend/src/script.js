...
function getAnalysis() {
  const from = startDate.value.split("-").reverse().join("-").concat(" ", startDateMinute.value.concat(":00")),
    to = endDate.value.split("-").reverse().join("-").concat(" ", endDateMinute.value.concat(":00"));
